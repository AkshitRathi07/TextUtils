...
export default function TexthtmlForm(props) {
    ...
    const[text,setText]=useState('');   //useState==HOOKS  //text==STATE VARIABLE //STATE
  ...
  <div className="container my-3" style={{color:props.mode==='dark'?'white':'#042743'}}>        
     ...
     <p>{0.008 * text.split(" ").filter((element)=>{return element.length!==0}).length} minutes taken to read it</p>
     <h2>Preview</h2>
